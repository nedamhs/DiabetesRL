...
class FeatureWrapper(gym.Wrapper):
    ...
    Build an augmented observation:
       [ normalized_CGM , original_obs..., time_of_day, meal_flag, cgm_slope ]
    ...
    def __init__(self, env):
        ...
        # --- CGM normalization bounds (assume obs[0] is mg/dL) ----
        ...
        # [ normalized_CGM + rest_of_obs , time_of_day , meal_flag , cgm_slope ]
    ...
    def _build_obs(self, obs, info):
        ...
        # ----  normalized CGM (assume obs[0] is mg/dL before scaling) ----
        raw_cgm = float(obs[0])
        ...
        # ---- binary meal flag from info['meal'] ----
